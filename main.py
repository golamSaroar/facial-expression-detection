from flask import Flask, request, jsonify, render_template, Response, send_file, send_from_directory, after_this_request
import os
...
app.config['IMAGE_DIR'] = os.path.join(BASE_DIR, 'static/images')
app.config['UPLOAD_DIR'] = os.path.join(BASE_DIR, 'storage/images')
